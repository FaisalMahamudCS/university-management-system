                                    ...
                                    <table id="example23" class="display nowrap table table-hover  table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $i = 1;
                                                $get_admin_data = "select * from skill order by 1 desc";
                                            ...
                                            <tr>
                                                ...
                                                <td><img style=";" src="../<?php echo $row_admin_data['picture']; ?>" width="100"></td>
                                                <td><?php echo $row_admin_data['course_desc']; ?></td>
                                                <td><?php echo $row_admin_data['course_duration']; ?></td>
                                         <?php $i++;  } ?>
                                            </tr>
