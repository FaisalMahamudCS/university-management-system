...
<li class="nav-item">
  ...
  <li class="nav-item">
    <a class="nav-link  btn btn-success" href="notice.php">
      <i class="fas fa-fw fa-user  "></i>
      <span style="text-shadow: 0px 1px 5px black;">Notice</span></a>
  </li>
                 ...
                 <div class="row"> 
                     ...
                     <div class="col-md-4 col-sm-6 mb-20"> 
                         ...
                         <span style="float:left; padding:0px 10px 0px 0px; margin:0px"> 
                             <img class="" src="image/13.jpg" style="border:#C49C29 5px solid; width:100px; height:125px"> 
                         </span> 
                     ...
                     <div class="col-md-4 col-sm-6 mb-20"> 
                         ...
                         <blockquote class="kopa-blockquote-2" style="text-align:justify; min-height:430px;"> 
                         <span style="float:left; padding:0px 10px 0px 0px; margin:0px"> 
                             <img class="visible animated" src="image/8060.jpg" style="border:#C49C29 5px solid; width:100px; height:125px"> 
                         </span> 
